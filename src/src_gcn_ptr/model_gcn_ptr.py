...
class GCNEncoder(nn.Module):
    def __init__(self, in_feats, hidden_size, num_layers, dropout):
        ...
        self.layers.append(GraphConv(
            in_feats, hidden_size, activation=F.relu,
        ...
        for _ in range(num_layers - 2):
            self.layers.append(GraphConv(
                hidden_size, hidden_size, activation=F.relu,
                norm='both', weight=True, bias=True
            ))
